...
import { loadMoongoose } from './prop';
import { Document, Model, Mongoose, SchemaOptions, Connection, Schema } from 'mongoose';
...
export class Typegoose {
  ...
  private buildSchema<T>(t: T, name: string, schemaOptions: any, sch?: Schema) {
